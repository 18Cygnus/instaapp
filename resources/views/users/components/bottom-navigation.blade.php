...
<div class="fixed bottom-0 w-[500px] z-50 h-16 bg-white border-t border-gray-200">
    <div class="grid h-full max-w-lg grid-cols-3 mx-auto font-medium">
        <a href="/home" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 group">
        ...
        <a href="/profile" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 group">
            ...
            <span class="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-300">Profile</span>
        </a>
    </div>
</div>
