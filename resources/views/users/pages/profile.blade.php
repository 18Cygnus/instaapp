...
@section('user')
    <section class="flex flex-col justify-center w-full pb-16">
        <div class="profile-data w-full px-4">
            ...
            <div class="bio mt-3">
                <p class="font-bold text-[16px]">Software Developer</p>
                <p class="text-gray-500 font-medium text-[14px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio repellendus laborum reiciendis</p>
            </div>
